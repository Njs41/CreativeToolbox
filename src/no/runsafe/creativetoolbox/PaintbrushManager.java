...
public class PaintbrushManager implements IPlayerLeftClickBlockEvent, IPlayerRightClickBlock, IConfigurationChanged
{
	...
	{
		return paintbrushes.containsKey(player) ? paintbrushes.get(player) : Item.Unavailable.Air;
	}
	...
	private final HashMap<IPlayer, Item> paintbrushes = new HashMap<IPlayer, Item>(0);
