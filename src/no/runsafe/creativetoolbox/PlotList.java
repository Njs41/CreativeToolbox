...
public class PlotList
{
	...
	private final ConcurrentHashMap<IPlayer, String> pointer = new ConcurrentHashMap<IPlayer, String>();
	private final ConcurrentHashMap<IPlayer, List<String>> lists = new ConcurrentHashMap<IPlayer, List<String>>();
}
